					...
					<div className="containt mes_equipes">
						<div className="title-lead EditTeam">
							...
							<div className="personal">
								...
								<div
									style={{ backgroundImage:`url(${team && team.banniere ?team.banniere : ImageTeam})`, backgroundPosition: 'center', backgroundSize: '100%', backgroundRepeat: 'no-repeat',cursor:"pointer" }}
									className="bg-team"
								...
								>
									<div className="logoteam_container">
										<div className="logo-team">
											<img
												src={team && team.logo ? team.logo : LogoTeam }
